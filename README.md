...
I picked [codingninjas.com](https://www.codingninjas.com/) because it has a clean, modern dark-themed design with several distinct sections that let me practice different React patterns like component composition, props, conditional rendering, and responsive layouts.

---

## Screenshots

> Run the project locally to see it in action (instructions below).

The clone includes the following sections visible on the landing page:

1. **Navbar** - Sticky navigation bar with the official logo, nav links, and auth buttons
2. **Hero Section** - Main headline with a decorative code editor mockup
3. **Stats Bar** - Key platform metrics (students, placements, rating, etc.)
4. **Courses Section** - Grid of course cards with images, ratings, and duration
5. **Why Us Section** - Feature cards highlighting platform benefits
6. **Testimonials** - Student success stories with avatars and quotes
7. **Footer** - Multi-column footer with links, social icons, and Google Play badge
...
```bash
git clone https://github.com/Aakif-Kohari/codingninjas-clone.git
```
...
**Built by Aakif Kohari** | QSkill Frontend Development Internship - Slab 2
